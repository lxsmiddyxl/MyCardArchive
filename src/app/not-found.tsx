...
export default function NotFound() {
  return (
    <div className="flex min-h-[min(24rem,calc(100vh-8rem))] flex-col items-center justify-center px-mca-base py-mca-stage text-center">
      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-mca-accent/80">404</p>
      <h1 className="mt-mca-sm text-2xl font-semibold text-mca-ink-strong">Page not found</h1>
      <p className="mt-mca-compact max-w-md text-sm text-mca-ink-muted">
        That page does not exist or you do not have access. Try home, your binders, or the launch
        page for what&apos;s new.
      </p>
      <div className="mt-mca-xl flex flex-col items-center gap-mca-compact sm:flex-row">
        ...
        <Link
          href="/launch"
          className="inline-flex min-h-[2.75rem] items-center justify-center rounded-mca-control border border-mca-field-border bg-mca-surface-elevated/60 px-mca-base py-mca-sm text-sm font-medium text-mca-ink-soft transition-all duration-200 ease-mca-standard hover:bg-mca-chrome/60"
        >
          What&apos;s new
        </Link>
      </div>
