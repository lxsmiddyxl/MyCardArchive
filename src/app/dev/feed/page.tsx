    ...
    <div className="mx-auto max-w-6xl space-y-mca-base px-mca-base py-mca-xl">
      <div>
        ...
        <p className="mt-mca-sm text-mca-body text-mca-ink-muted">
          ...
          <code className="text-mca-accent/90">get_global_feed_v2</code>. Production:{" "}
          <code className="text-mca-accent/90">GET /api/feed</code> (omit <code className="text-mca-accent/90">debug=1</code> to strip
          payloads).
        </p>
      </div>
      <FeedInspectorClient />
